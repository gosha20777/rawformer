...
from rawformer.torch.select            import (
    select_optimizer, extract_name_kwargs
)
from rawformer.torch.queue             import FastQueue
from rawformer.torch.funcs             import prepare_model, update_average_model
from rawformer.torch.layers.batch_head import BatchHeadWrapper, get_batch_head
from rawformer.base.losses             import GANLoss
from rawformer.torch.losses            import PixelWiseLoss
from rawformer.torch.gradient_penalty  import GradientPenalty
from rawformer.models.discriminator    import construct_discriminator
from rawformer.models.generator        import construct_generator
...
class RawFormerGan(ModelBase):
    ...
    def __init__(
        ...
        self.criterion_cycle   = PixelWiseLoss().to(self.device)
