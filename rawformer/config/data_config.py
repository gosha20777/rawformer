...
from rawformer.consts      import MERGE_PAIRED, MERGE_UNPAIRED, MERGE_NONE
from rawformer.utils.funcs import check_value_in_range

from .config_base import ConfigBase

LOGGER      = logging.getLogger('rawformer.config')
